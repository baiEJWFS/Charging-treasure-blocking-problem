...
parser.add_argument('--save_folder', default=val_save_folder, type=str,
...
# annopath = os.path.join(args.sixray_root, 'coreless_3000', 'Annotation', '%s.txt')
annopath = os.path.join(args.sixray_root, 'Anno_core_coreless_battery_sub_2000_500','%s')
#imgpath = os.path.join(args.sixray_root, 'coreless_3000', 'Image', '%s.jpg')
imgpath = os.path.join(args.sixray_root, 'cut_Image_core_coreless_battery_sub_2000_500', '%s.jpg')
# imgsetpath = os.path.join(args.sixray_root, 'coreless_3000', 'ImageSets',
#                           'Main', '{:s}_coreless_3000.txt')
imgsetpath = os.path.join(args.sixray_root, 'train_test_txt', 'battery_sub','sub_test_core_coreless.txt')

# devkit_path = args.sixray_root + 'coreless_3000'
...
def do_python_eval(output_dir='output', use_07=True):
    ...
    print('SIXRAY metric? ' + ('Yes' if use_07_metric else 'No'))
